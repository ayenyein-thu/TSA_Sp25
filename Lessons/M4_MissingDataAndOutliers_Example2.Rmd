...
```{r}
forecast_cleaned <- forecast::na.interp(ts_wind_data)

autoplot(forecast_cleaned, series="Wind Clean") +
  autolayer(ts_wind_data, series="Wind Raw") +
  ylab("Average Wind Speed") 

zoo_cleaned <- zoo::na.approx(ts_wind_data)

autoplot(zoo_cleaned, series="Wind Clean") +
  autolayer(ts_wind_data, series="Wind Raw") +
  ylab("Average Wind Speed") 
```
