...
deseaon_inflow_data <- detrend_inflow - inflow_seas_comp

ts_deseaon_inflow_data <- ts(deseaon_inflow_data, start=c(1931,1), frequency = 12)

autoplot(ts_inflow_data[,iHP]) + 
  autolayer(ts_deseaon_inflow_data, series="Detrend and deseasoned Inflow")
```
